...
| decimal     |               | `42.0`                 | A decimal that can hold arbitrarily large finite positive and negative decimal values with arbitrary precision. Additionally, it can hold the special values \`infinity\`, \`-infinity \` and \`nan\`. |
...
| amount      |               | `42m`                  | A value consisting of an arbitrary size and precision decimal number and a (composite) SI unit or currency unit                                                                                                                                       |
